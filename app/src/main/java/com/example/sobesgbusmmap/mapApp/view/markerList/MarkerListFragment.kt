...
import com.example.sobesgbusmmap.mapApp.IonBackPressed
import com.example.sobesgbusmmap.databinding.MarkerListFragmentBinding
import com.example.sobesgbusmmap.mapApp.model.Dependencies
import com.example.sobesgbusmmap.mapApp.model.room.MarkerData
import com.example.sobesgbusmmap.mapApp.view.map.IRefreshMarkers
import com.example.sobesgbusmmap.mapApp.viewModel.markerList.MarkerListViewModel

class MarkerListFragment(private val callbackRefreshMarkers: IRefreshMarkers) : Fragment(),
    IonBackPressed {
